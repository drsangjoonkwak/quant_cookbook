URL <- "https://api.finance.naver.com/siseJson.naver?symbol=012450&requestType=1&startTime=20191020&endTime=20210806&timeframe=day"
...
url = paste0('https://api.finance.naver.com/siseJson.naver?symbol=', 
             name, 
             '&requestType=1&startTime=', from, 
             '&endTime=', to, '&timeframe=day')
